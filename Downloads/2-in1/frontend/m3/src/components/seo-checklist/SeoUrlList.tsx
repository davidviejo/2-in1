  ...
  const handleSyncGscMetrics = async () => {
    ...
    try {
      ...
      for (const row of rows) {
        ...
        const prev = metricsByUrl.get(normalizedUrl) || { clicks: 0, impressions: 0, weightedPosition: 0 };
        ...
        metricsByUrl.set(normalizedUrl, {
          ...
          weightedPosition: prev.weightedPosition + position * impressions,
        });
      }
      ...
      for (const page of targetPages) {
        ...
        const position = row.impressions > 0 ? row.weightedPosition / row.impressions : undefined;
