  ...
  if (projectType === 'MEDIA') {
    ...
    if (mediaLowCtrTop10.length) {
      candidates.push({
        ...
        relatedRows: mediaLowCtrTop10.map((row) => row.current).slice(0, 50),
    ...
    if (mediaCoverageExpansion.length) {
      candidates.push({
        ...
        relatedRows: mediaCoverageExpansion.map((row) => row.current).slice(0, 50),
    ...
    if (mediaLowDepthRows.length) {
      candidates.push({
        ...
        relatedRows: mediaLowDepthRows.map((row) => row.current).slice(0, 50),
    ...
    if (ecommercePositions.length) {
      candidates.push({
        ...
        relatedRows: ecommercePositions.map((row) => row.current).slice(0, 50),
    ...
    if (ecomPlpLowCtrFiltered.length) {
      candidates.push({
        ...
        relatedRows: ecomPlpLowCtrFiltered.map((row) => row.current).slice(0, 50),
    ...
    if (ecomNoDominantUrl.length) {
      ...
      candidates.push({
        ...
        relatedRows: lead.rows.slice(0, 50),
    ...
    if (localServiceCityRows.length) {
      candidates.push({
        ...
        relatedRows: localServiceCityRows.map((row) => row.current).slice(0, 50),
    ...
    if (localBranded.length && localServiceWeak.length) {
      candidates.push({
        ...
        relatedRows: localServiceWeak.map((row) => row.current).slice(0, 50),
    ...
    if (localGrowingServicePages.length) {
      candidates.push({
        ...
        relatedRows: localGrowingServicePages.map((row) => row.current).slice(0, 50),
    ...
    if (nationalCtrRows.length) {
      candidates.push({
        ...
        relatedRows: nationalCtrRows.map((row) => row.current).slice(0, 50),
    ...
    if (nationalHubGrowth.length) {
      candidates.push({
        ...
        relatedRows: nationalHubGrowth.map((row) => row.current).slice(0, 50),
    ...
    if (internationalGapRows.length) {
      candidates.push({
        ...
        relatedRows: internationalGapRows.map((row) => row.current).slice(0, 50),
