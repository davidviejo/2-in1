...
const GscImpactPage: React.FC = () => {
  ...
  const isStandaloneClusterPage = location.pathname.endsWith('/gsc-clusters');
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="section-title">
                {isStandaloneClusterPage ? 'Clusterización GSC por niveles' : 'Impacto GSC por rollout'}
              </h1>
              <p className="section-subtitle">
                {isStandaloneClusterPage
                  ? 'Página dedicada para análisis por clúster y oportunidades por nivel.'
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
              <div>
                ...
                >
                  ...
                  {!isStandaloneClusterPage && <option value="global">Impacto global GSC (portfolio)</option>}
                </select>
              </div>
              {viewMode === 'global' && (
                <>
...
export default GscImpactPage;
  useEffect(() => {
    if (isStandaloneClusterPage && viewMode !== 'individual') {
      setViewMode('individual');
    }
  }, [isStandaloneClusterPage, viewMode]);
